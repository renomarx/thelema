...
func Bestiary() []*MonsterType {
	return []*MonsterType{
		...
		&MonsterType{Tile: Snake, Name: "Snake", Health: 100, Energy: 200, Stats: 10, Speed: 5, Luck: 0, VisionRange: 7, Probability: 80},
		&MonsterType{Tile: Cat, Name: "Cat", Health: 100, Energy: 300, Stats: 10, Speed: 10, Luck: 20, VisionRange: 7, Probability: 70},
		&MonsterType{Tile: Eagle, Name: "Eagle", Health: 200, Energy: 200, Stats: 20, Speed: 7, Luck: 25, VisionRange: 9, Probability: 50},
		&MonsterType{Tile: Wolf, Name: "Wolf", Health: 300, Energy: 300, Stats: 40, Speed: 8, Luck: 10, VisionRange: 7, Probability: 30},
		&MonsterType{Tile: Bear, Name: "Bear", Health: 500, Energy: 200, Stats: 50, Speed: 7, Luck: 20, VisionRange: 7, Probability: 20},
		&MonsterType{Tile: Elephant, Name: "Elephant", Health: 800, Energy: 200, Stats: 80, Speed: 7, Luck: 20, VisionRange: 5, Probability: 20},
	}
}
