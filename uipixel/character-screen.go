...
const CharacteristicColumnLength float64 = 200

func (ui *UI) DrawCharacteristics(p *game.Character, offsetX, offsetH float64) float64 {
	_, h := ui.DrawText(
	...
	_, h = ui.DrawText(
		...
		TextSizeM,
		ColorActive,
		offsetX+CharacteristicColumnLength,
		offsetH)
